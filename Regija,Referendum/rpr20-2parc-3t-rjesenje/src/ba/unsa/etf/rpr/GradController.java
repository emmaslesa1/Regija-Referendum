...
public class GradController {
    ...
    public TextField fieldRegija;
    private Grad grad;
    private boolean referendum;
    ...
    public void initialize() {
        ...
        if (grad != null) {
            ...
            fieldRegija.setText(grad.getRegija());
    ...
    public void clickOk(ActionEvent actionEvent) {
        ...
        grad.setRegija(fieldRegija.getText());
        Stage stage = (Stage) fieldNaziv.getScene().getWindow();
        stage.close();
    }

    public void clickReferendum(ActionEvent actionEvent) {
        referendum = true;
        clickOk(actionEvent);
    }
